...
function Restaurant() {
  ...
  //     },
  //     prefill: {
  //       name: 'Liladhar Sapkota',
  //       email: 'Liladharsapkota12@gmail.com',
  //       contact: '0405326790',
  //     },
  //   };
  ...
  let getPaymentView = async () => {
    try {
      ...
      const session = await stripe.redirectToCheckout({
        lineItems: [
          {
            price: 'your-stripe-price-id', // Replace with the actual Stripe Price ID
            quantity: 1,
          },
        ],
        mode: 'payment',
      ...
      if (session.error) {
        ...
        // Handle success or continue with the session object
      }
    } catch (error) {
      console.error('Error in payment view:', error.message);
    }
  };
            ...
            <div className='modal-dialog modal-dialog-centered'>
              <div className='modal-content'>
                ...
                <div className='modal-body'>
                  ...
                  <div className='mb-3'>
                    ...
                    <input
                      ...
                      value='Liladharsapkota12@gmail.com'
                      onChange={() => {}}
                    />
                  </div>
                  <div className='mb-3'>
                ...
                <div className='modal-footer'>
                  ...
                  <button className='btn btn-warning' onClick={goToCheckout}>
                    Pay Later
                  </button>
                </div>
              </div>
